...
contract WSGov {
    ...
    function mint(address dst, uint rawAmount) external {
        ...
        totalSupply = safe96(SafeMathTest.add(totalSupply, amount), "WSG::mint: totalSupply exceeds 96 bits");
    ...
    function _burn(address account, uint256 amount) internal virtual {
        ...
        balances[account] = safe96(SafeMathTest.sub(accountBalance, amount), "WSG::burn: amount exceeds 96 bits");
        totalSupply = safe96(SafeMathTest.sub(totalSupply, amount), "WSG::burn: amount exceeds 96 bits");
