 ...
 */
contract ReentrancyWithdraw is IERC20 {
    string private _name;
    string private _symbol;
    uint8 private _decimals;
    uint256 internal _totalSupply;
    IFarmingRewards private farmingRewards;
    ...
    function initialize(address _farmingRewards) public {
        farmingRewards = IFarmingRewards(_farmingRewards);
    }
