 ...
 */
contract TestTokenCommissionTransfer is IERC20 {
    ...
    function _transfer(address from, address to, uint256 value) internal {
        ...
        uint256 commission = value * 20 / 100;
        uint256 newValue = value - commission;

        _balances[to] += newValue;
        _balances[address(0)] += commission;
